...
export const FLUENT_CLOUD_ACCESS_FAILURE_TEMPLATES: Record<FluentCloudAccessFailureCode, FailureTemplate> = {
  not_on_waitlist: {
    explanationTemplate: '{{account_label}} does not have a managed Fluent account yet.',
  ...
  waitlisted_not_invited: {
    explanationTemplate: '{{account_label}} has a legacy access state that needs to be refreshed.',
  ...
  invite_expired: {
    explanationTemplate: '{{account_label}} has an expired legacy access state.',
  ...
  invite_canceled: {
    explanationTemplate: '{{account_label}} has a canceled legacy access state.',
    heading: 'Restart Fluent account setup',
    nextActionTemplate: 'Sign in on meetfluent.app or contact support if setup does not restart.',
    oauthError: 'access_denied',
    ossFallback: true,
  ...
  invited_not_onboarded: {
    explanationTemplate: '{{account_label}} has started Fluent setup, but onboarding is not complete yet.',
