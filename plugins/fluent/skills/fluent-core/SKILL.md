...
- Domain readiness does not imply rich-surface support. In Codex, OpenClaw, and generic plain MCP clients, default to canonical data and text unless the live host explicitly proves widget support.
